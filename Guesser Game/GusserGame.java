...
class Umpire
{
	...
	public void getNumOfPlayers()
	{
		...
		if(numOfPlayers < 0)
		{
			System.out.println("Number of players should be greater than zero and lesser than equal to 10");
			System.exit(0);
		}
...
public class Guessgame {
	...
	public static void main(String[] args) {
		...
		while (rounds > 10)
		{
			System.out.println("Please enter rounds that is less than or equal to 10");
			rounds = s1.nextInt();
		}
